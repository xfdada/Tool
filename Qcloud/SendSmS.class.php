...
{
    // 短信应用SDK AppID
    private $appid = 1400218923; // 1400开头

    // 短信应用SDK AppKey
    private $appkey = "236d613de50948e8c0de937795c14a8a";
    ...
    {
//        $phoneNumbers = ["15347974139"];
// 短信模板ID，需要在短信应用中申请
        $templateId = 347726;  // NOTE: 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请
// 签名
